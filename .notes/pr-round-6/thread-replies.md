...
One thing worth naming, since the CHANGELOG protects a different person from the one at risk: someone who
reads release notes is now warned, and someone who picks Wipe with a gen3 card on the reader still sees
