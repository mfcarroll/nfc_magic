...
| 10 | new issue — NFC Magic: a card removed mid-write is not reported on Gen… | `issue-2-poller-timeouts.md` |
...
**Title:** NFC Magic: a card removed mid-write is not reported on Gen2/Classic or USCUID-UL — every remaining block is retried instead
