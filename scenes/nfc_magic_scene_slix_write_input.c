...
static void nfc_magic_scene_slix_write_input_callback(void* context) {
    NfcMagicApp* instance = context;
    view_dispatcher_send_custom_event(
        instance->view_dispatcher, NfcMagicAppCustomEventByteInputDone);
}

void nfc_magic_scene_slix_write_input_on_enter(void* context) {
    NfcMagicApp* instance = context;
    ...
    byte_input_set_result_callback(
        byte_input,
        nfc_magic_scene_slix_write_input_callback,
        NULL,
        instance,
        instance->slix_target_uid,
        ISO15693_3_UID_SIZE);
...
bool nfc_magic_scene_slix_write_input_on_event(void* context, SceneManagerEvent event) {
    NfcMagicApp* instance = context;
    bool consumed = false;
...
void nfc_magic_scene_slix_write_input_on_exit(void* context) {
    NfcMagicApp* instance = context;
