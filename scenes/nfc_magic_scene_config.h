...
ADD_SCENE(nfc_magic, slix, Slix)
ADD_SCENE(nfc_magic, slix_get_info, SlixGetInfo)
ADD_SCENE(nfc_magic, slix_info, SlixInfo)
ADD_SCENE(nfc_magic, slix_save_name, SlixSaveName)
ADD_SCENE(nfc_magic, slix_write_input, SlixWriteInput)
ADD_SCENE(nfc_magic, slix_write_confirm, SlixWriteConfirm)
ADD_SCENE(nfc_magic, slix_write, SlixWrite)
ADD_SCENE(nfc_magic, slix_write_fail, SlixWriteFail)
